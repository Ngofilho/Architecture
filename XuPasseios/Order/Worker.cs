...
namespace Order
{
    public class Worker : BackgroundService
    {
        ...
        {
            this._logger.LogInformation("Stopping the RabbitMQ service for the Order");
            await this.rabbitMQService.StopAsync(cancellationToken);
            this._logger.LogInformation("Disposing the RabbitMQ service for the Order");
            this.rabbitMQService.Dispose();
            this._logger.LogInformation("Stopped and disposed the RabbitMQ service for the Order");
        }
    }
}
