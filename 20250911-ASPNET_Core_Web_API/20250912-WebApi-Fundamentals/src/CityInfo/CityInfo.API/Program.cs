...
Log.Logger = new LoggerConfiguration()
    ...
    /*.WriteTo.ApplicationInsights(
        ...
        { 
            InstrumentationKey = "chave de configuracao"
        }, 
...
else
{
    var secretClient = new SecretClient(
        new Uri("The address of the Azure Key Vault"),
...
{
    op.AddPolicy("MustBeFromAntwerp", policy =>
    {
...
var apiVersionDescriptionProider = builder.Services.BuildServiceProvider()
    .GetRequiredService<IApiVersionDescriptionProvider>();

builder.Services.AddSwaggerGen(setupAction =>
{
    foreach (var description in apiVersionDescriptionProider.ApiVersionDescriptions)
    {
